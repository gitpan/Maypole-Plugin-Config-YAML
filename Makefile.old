# This Makefile is for the Maypole::Plugin::Config::YAML extension to perl.
#
...
#     NAME => q[Maypole::Plugin::Config::YAML]
#     PREREQ_PM => { YAML=>q[0], Maypole=>q[2.0] }
...
NAME_SYM = Maypole_Plugin_Config_YAML
VERSION = 0.04
...
FULLEXT = Maypole/Plugin/Config/YAML
BASEEXT = YAML
PARENT_NAME = Maypole::Plugin::Config
DLBASE = $(BASEEXT)
...
INST_LIBDIR      = $(INST_LIB)/Maypole/Plugin/Config
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Maypole/Plugin/Config
...
PM_TO_BLIB = YAML.pm \
	$(INST_LIB)/Maypole/Plugin/Config/YAML.pm
...
DISTNAME = Maypole-Plugin-Config-YAML
DISTVNAME = Maypole-Plugin-Config-YAML-0.04
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3pm --perm_rw=$(PERM_RW)\
	  YAML.pm $(INST_MAN3DIR)/Maypole::Plugin::Config::YAML.$(MAN3EXT) 
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  $(INST_LIB)/Maypole/Plugin/Config/YAML.pm $(MAKEFILE_OLD) $(FIRST_MAKEFILE)
...
metafile :
	...
	$(NOECHO) $(ECHO) 'name:         Maypole-Plugin-Config-YAML' >> META.yml
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')'\
	  YAML.pm $(INST_LIB)/Maypole/Plugin/Config/YAML.pm 
	$(NOECHO) $(TOUCH) $@
